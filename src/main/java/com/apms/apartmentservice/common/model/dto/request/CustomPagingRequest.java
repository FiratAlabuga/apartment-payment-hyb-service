package com.apms.apartmentservice.common.model.dto.request;

import com.apms.apartmentservice.common.model.dto.BasePaging;
...
public class CustomPagingRequest {
    ...
    private BasePaging pagination;

    /**
     * Converts {@link BasePaging} into a Spring {@link Pageable} instance.
     *
