package com.apms.apartmentservice.auth.security;

import com.apms.apartmentservice.common.model.dto.BaseApiError;
 ...
 * It returns a structured JSON response with {@code 401 Unauthorized} status using {@link BaseApiError}.
...
public class BaseAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    /**
     * Handles authentication failures by returning a JSON-formatted {@link BaseApiError} response.
     *
    ...
    public void commence(final HttpServletRequest httpServletRequest,
        ...
        final BaseApiError customError = BaseApiError.builder()
                .header(BaseApiError.Header.AUTH_ERROR.getName())
