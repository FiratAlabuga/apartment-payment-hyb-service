package com.apms.apartmentservice.auth.config;

import com.apms.apartmentservice.auth.security.BaseAuthenticationEntryPoint;
import lombok.RequiredArgsConstructor;
import com.apms.apartmentservice.auth.filter.CustomBearerTokenAuthenticationFilter;
 ...
 * @see BaseAuthenticationEntryPoint
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(
            ...
            final BaseAuthenticationEntryPoint customAuthenticationEntryPoint
    ) throws Exception {
